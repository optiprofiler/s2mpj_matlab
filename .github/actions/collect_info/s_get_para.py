...
def s_get_para(language='matlab', max_para=500):
    ...
    # Search and copy the file 'list_of_<language>_problems' to the path './list_of_parametric_problems_<language>.txt'
    src_file = 'src/list_of_' + language + '_problems'
    ...
    # First Scan the language_files_folder, if the .m (or .py) file contains string '$-PARAMETER', then add the name before .m (or .py) to the txt file names_file_path. Finally sort the names in the names_file_path.
